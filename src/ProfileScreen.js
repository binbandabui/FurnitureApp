...
const ProfileScreen = (props) => {
    ...
    const user = [
        { id: '1', name: 'Brono Pham', email: 'bruno102@gmail.com', avatar: 'https://fastly.picsum.photos/id/795/200/200.jpg?hmac=frCAqjE9buwwg1NjgwTe6Ef_WWIJOl5h2c6-TFjnlA4' },
            ...
            <View style={styles.itemcontainer2}>
                <View style={styles.itemcontainer3}>
                    ...
                    <TouchableOpacity style={styles.bt}>
                        <Image style={styles.img} source={require('../asset/img/Frame_15.png')} />
                    </TouchableOpacity>
                </View>
            </View>
        </TouchableOpacity>
            ...
            <View style={styles.listItem}>
                <View style={styles.ava}>
                    ...
                    <View style={{ fontSize: 18, marginLeft: 25, marginTop: 15 }}>
                        <Text style={{ color: "#242424", fontSize: 20, fontWeight: '700' }}>{item.name}</Text>
                        <Text style={{ color: "#808080", fontSize: 14, fontWeight: '400' }}>{item.email}</Text>
                    </View>
                </View>
            </View>
        </TouchableOpacity>
    ...
    return (
        ...
        <View style={styles.containertab}>
            <View style={styles.head}>
                ...
                <Text style={{ color: 'black', fontFamily: 'NuniTo Sans', fontWeight: '700', fontSize: 16 }}>Profile</Text>
                <TouchableOpacity>
                    <Image style={{
                        width: 30,
                        height: 30,
