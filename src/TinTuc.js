                    ...
                    data.map((item, index) => {
                        return (
                            <View key={index}>
                                <View style={styles.bigview}>
                                    <View style={styles.hinhanh}>
                                        <Image source={require('../asset/img/tintuc.png')} style={styles.img} /></View>
                                    <View style={styles.smallview}>
...
var DATA = [
    ...
    {
        tieude: 'Your order #123456789 has been confirmed', noidung: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis pretium et in arcu adipiscing nec. Turpis pretium et in arcu adipiscing nec. '
    },
]